...
(h._creditLink = document.createElement("a"), h._creditLink.setAttribute("class", "canvasjs-chart-credit"), h._creditLink.setAttribute("title", "JavaScript Charts"), h._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:2px;top:" + (h.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"), h._creditLink.setAttribute("tabIndex", -1), h._creditLink.setAttribute("target", "_blank")); if (0 === h.renderCount ||
...
}   H = ""; for (L = !1; 0 < R.length;) {p = R.shift(), "#" === p || "0" === p ? 0 < h.length && 0 !== Number(h.join("")) ? (H += h.shift(), L = !0) : "0" === p && (H += "0", L =
...
}                                                                           r += (L ? v : "") + H; return u ? "-" + r : r; }, Ra = function(h) {var p = 0, r = 0; h = h || window.event; h.offsetX || 0 === h.offsetX ? (p = h.offsetX, r = h.offsetY) : h.layerX || 0 == h.layerX ? (p = h.layerX, r = h.layerY) : (p = h.pageX - h.target.offsetLeft,
...
}} else { Ja && window.console && console.log("defaults not set"); }}; V.prototype.get = function(h) {var p = ra[this._defaultsKey]; if ("options" === h) {return this.options && this.options._isPlaceholder ? null : this.options; }if (p.hasOwnProperty(h) || p.publicProperties && p.publicProperties.hasOwnProperty(h)) {return this[h]; }window.console && window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."); }; V.prototype.set = function(h, p, r) {r = "undefined" ===
  typeof r ? !0 : r;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            var u = ra[this._defaultsKey]; if ("options" === h) {this.createUserOptions(p); } else if (u.hasOwnProperty(h) || u.publicProperties && u.publicProperties.hasOwnProperty(h) && "readWrite" === u.publicProperties[h]) {this.options._isPlaceholder && this.createUserOptions(), this.options[h] = p; } else {window.console && (u.publicProperties && u.publicProperties.hasOwnProperty(h) && "readOnly" === u.publicProperties[h] ? window.console.log('Property "' + h + '" is read-only.') : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."));
    ...
    this.parent.options[this.optionsName], r = p.length;                                                                                                                                                                                                                                                                                                                                                                                 this.options._isPlaceholder || (Fa(p), r = p.indexOf(this.options)); this.options = "undefined" === typeof h ? {} : h; p[r] = this.options; } else { this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? p = this.optionsName : (p = this._defaultsKey) && 0 !== p.length ? (r = p.charAt(0).toLowerCase(), 1 < p.length && (r = r.concat(p.slice(1))), p = r) : p = void 0, h[p] = this.options; }
}}; V.prototype.remove = function(h) {h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) {var p =
...
}                         this.ctx.font = p; h && this.ctx.restore(); }}; ka.prototype.setText = function(h) {this.text = h; this._isDirty = !0; this._wrappedText = null; }; ka.prototype.measureText = function() {this._lineHeight = Za(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) {throw new Error("Please set maxWidth and height for TextBlock"); }this._wrapText(this.ctx);
...
}                                                                this._wrappedText = {lines: p, width: v, height: u}; this.width = v + (this.leftPadding + this.rightPadding); this.height = u + (this.topPadding + this.bottomPadding); this.ctx.font = r; }; ka.prototype._getFontString = function() {var h; h = "" + (this.fontStyle ? this.fontStyle + " " : ""); h += this.fontWeight ? this.fontWeight + " " : ""; h += this.fontSize ? this.fontSize + "px " : ""; var p = this.fontFamily ? this.fontFamily + "" : ""; !r && p && (p = p.split(",")[0], "'" !== p[0] && '"' !== p[0] && (p = "'" + p + "'")); return h += p; };
  ...
  c.type || "ohlc" === c.type || "waterfall" === c.type || "boxAndWhisker" === c.type ? [this._selectedColorSet[0]] : this._selectedColorSet : c._colorSet = [c.color]; null === c.markerSize && (("line" === c.type || "stepLine" === c.type || "spline" === c.type || 0 <= c.type.toLowerCase().indexOf("area")) && c.dataPoints && c.dataPoints.length < this.width / 16 || "scatter" === c.type) && (c.markerSize = 8); "bubble" !== c.type && "scatter" !== c.type || !c.dataPoints || (c.dataPoints.some ? c.dataPoints.some(function(a) {return a.x; }) && c.dataPoints.sort(h) : c.dataPoints.sort(h));
...
}if ("secondary" === this.data[d].axisYType) {if (this.options.axisY2 && 0 < this.options.axisY2.length) {if (!this.axisY2.length) {for (b = 0; b < this.options.axisY2.length; b++) {"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new z(this, "axisY2", this.options.axisY2[b], b,
...
}                                                                                                                                                                          this.data[d].axisY = this.axisY2[0 <= this.data[d].axisYIndex && this.data[d].axisYIndex < this.axisY2.length ? this.data[d].axisYIndex : 0]; this.axisY2[0 <= this.data[d].axisYIndex && this.data[d].axisYIndex < this.axisY2.length ? this.data[d].axisYIndex : 0].dataSeries.push(this.data[d]); } else { this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] =
...
}if (!this.data[d].axisXType || "primary" === this.data[d].axisXType) {if (this.options.axisX && 0 < this.options.axisX.length) {if (!this.axisX.length) {for (b = 0; b < this.options.axisX.length; b++) {"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] =
...
}                                                                                                                                                                                                this.data[d].axisX = this.axisX[0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX.length ? this.data[d].axisXIndex : 0]; this.axisX[0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX.length ? this.data[d].axisXIndex : 0].dataSeries.push(this.data[d]); } else { this.axisX.length || ("normal" === this.plotInfo.axisPlacement ?
...
}if ("secondary" === this.data[d].axisXType) {if (this.options.axisX2 && 0 < this.options.axisX2.length) {if (!this.axisX2.length) {for (b = 0; b < this.options.axisX2.length; b++) {"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] =
...
}if (this.axisY) {for (b = 1; b < this.axisY.length; b++) {"undefined" === typeof this.axisY[b].options.gridThickness && (this.axisY[b].gridThickness = 0); }for (b = 0; b < this.axisY.length - 1; b++) {"undefined" ===
    ...
    (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (d = 0; d < this.plotInfo.plotTypes.length; d++) {for (var g = this.plotInfo.plotTypes[d], k = 0; k < g.plotUnits.length; k++) {var l = g.plotUnits[k], w = null; l.targetCanvas =
      ...
      b.push(this.renderIndexLabels(e)));                                                                                                                                                                                                                var s = this; if (0 < b.length) {s.disableToolTip = !0, s._animator.animate(200, s.animationDuration, function(a) {s.ctx.clearRect(0, 0, s.width, s.height); s.ctx.drawImage(c, 0, 0, Math.floor(s.width * W), Math.floor(s.height * W), 0, 0, s.width, s.height); for (var e = 0; e < b.length; e++) {w = b[e], 1 > a && "undefined" !== typeof w.startTimePercent ? a >= w.startTimePercent && w.animationCallback(w.easingFunction(a - w.startTimePercent, 0, 1, 1 - w.startTimePercent), w) : w.animationCallback(w.easingFunction(a, 0, 1, 1), w); }
                                                                                                                                              s.dispatchEvent("dataAnimationIterationEnd", {chart: s}); }, function() {b = []; for (var a = 0; a < s.plotInfo.plotTypes.length; a++) {for (var e = s.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) {e.plotUnits[d].targetCanvas = null; } }c = null; s.disableToolTip = !1; });
} else {if (s._breaksCanvas) {if (r) {s.plotArea.ctx.drawImage(s._breaksCanvas, 0, 0, this.width, this.height); } else { for (m = 0; m < s._axes.length; m++) {s._axes[m].createMask(); } } }0 < s._indexLabels.length && s.renderIndexLabels(); s.dispatchEvent("dataAnimationIterationEnd", {chart: s}); }this.attachPlotAreaEventHandlers();
      ...
      b.plotUnits[k].axisXIndex === a.axisXIndex) {g = !0; e = b.plotUnits[k]; break; }
        ...
        a.axisXIndex : 0] : this.axisX2[0 <= a.axisXIndex && a.axisXIndex < this.axisX2.length ? a.axisXIndex : 0], dataSeriesIndexes: [], yTotals: []}, b.plotUnits.push(e)); b.totalDataSeries++; e.dataSeriesIndexes.push(d); a.plotUnit = e; }
}                                                                                                                                                                                                                                                                              for (d = 0; d < this.plotInfo.plotTypes.length; d++) {for (b = this.plotInfo.plotTypes[d], k = a = 0; k < b.plotUnits.length; k++) {b.plotUnits[k].previousDataSeriesCount = a, a += b.plotUnits[k].dataSeriesIndexes.length; } }};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  p.prototype.assignIdToDataPoints = function() {for (var a = 0; a < this.data.length; a++) {var d = this.data[a];
...
}                                                                                                                                                                                                                                                                                                                                          null !== e && null !== l.dataPoints[w - 1].y && (a.axisY.logarithmic ? (B = e / l.dataPoints[w - 1].y, 1 > B && (B = 1 / B), d.minDiff > B && 1 !== B && (d.minDiff = B)) : (B = e - l.dataPoints[w - 1].y, 0 > B && (B *= -1), d.minDiff > B && 0 !== B && (d.minDiff = B))); }if (c < n && !m) {null !== e && (q = c); } else {if (!m && (m = !0, 0 < w)) {w -= 2; continue; }if (c > f && !s) {s = !0; } else if (c > f && s) {continue; }l.dataPoints[w].label && (a.axisX.labels[c] = l.dataPoints[w].label); c < b.viewPortMin && (b.viewPortMin = c); c > b.viewPortMax && (b.viewPortMax = c); null === e ? b.viewPortMin ===
      c && q < c && (b.viewPortMin = q) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax = e)); }}                                                                                                                                 l.axisX.valueType = l.xValueType = g ? "dateTime" : "number"; }
}};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  p.prototype._processStackedPlotUnit = function(a) {if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = [], l = [], w = Infinity, m = -Infinity, s = 0; s < a.dataSeriesIndexes.length; s++) {var q = this.data[a.dataSeriesIndexes[s]], n = 0, f = !1, B = !1, h; if ("normal" === q.axisPlacement ||
...
}if (l.dataPoints[w].x && l.dataPoints[w].x.getTime || "dateTime" === l.xValueType) {g = !0; }for (w = 0; w < l.dataPoints.length; w++) {"undefined" !== typeof l.dataPoints[w].isCumulativeSum && !0 === l.dataPoints[w].isCumulativeSum ?
...
}};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   p.prototype.calculateAutoBreaks = function() {function a(a, c, b, e) {if (e) {return b = Math.pow(Math.min(b * a / c, c / a), 0.2), 1 >= b && (b = Math.pow(1 > a ? 1 / a : Math.min(c / a, a), 0.25)), {startValue: a * b, endValue: c / b}; }b = 0.2 * Math.min(b - c + a, c - a); 0 >= b && (b = 0.25 * Math.min(c - a, Math.abs(a))); return{startValue: a + b, endValue: c -
...
}}                         for (var c, e = this, g = !1, k = 0; k < this._axes.length; k++) {if (this._axes[k].scaleBreaks && this._axes[k].scaleBreaks.autoCalculate && 1 <= this._axes[k].scaleBreaks.maxNumberOfAutoBreaks) {g = !0; this._axes[k].dataInfo._dataRanges = []; for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[k].scaleBreaks.collapsibleThreshold) ||
      10, 10); l++) {this._axes[k].dataInfo._dataRanges.push({min: Infinity, max: -Infinity}); }}
                         }                                                                                                                                                                             if (g) {for (k = 0; k < this.plotInfo.plotTypes.length; k++) {for (g = this.plotInfo.plotTypes[k], l = 0; l < g.plotUnits.length; l++) {c = g.plotUnits[l], "line" === c.type || "stepLine" === c.type || "spline" === c.type || "column" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "bar" === c.type || "bubble" === c.type || "scatter" === c.type || "candlestick" === c.type || "ohlc" === c.type || "rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" ===
    ...
    1; l++) {if (s = m[l].max, isFinite(s)) {for (; l < m.length - 1;) {if (w = m[l + 1].min, isFinite(w)) {q = w - s; q > c && g.push({diff: q, start: s, end: w}); break; } else { l++; } } } }                                                                           if (this._axes[k].scaleBreaks.customBreaks) {for (l = 0; l < this._axes[k].scaleBreaks.customBreaks.length; l++) {for (c = 0; c < g.length; c++) {if (this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].start && g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue || this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].start && g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue ||
      g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].startValue && this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].end || g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue && this._axes[k].scaleBreaks.customBreaks[l].endValue <= g[c].end) {g.splice(c, 1), c--; }
                                                                           ...
                                                                           }g.sort(function(a, c) {return c.diff - a.diff; }); for (l = 0; l < Math.min(g.length, this._axes[k].scaleBreaks.maxNumberOfAutoBreaks); l++) {c = a(g[l].start, g[l].end, this._axes[k].logarithmic ? this._axes[k].dataInfo.max / this._axes[k].dataInfo.min :
...
}}};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            p.prototype.getDataPointAtXY = function(a, d, b) {b = b || !1; for (var c =
    ...
    "mouseup" === b && window.console.log("mouseup")), !e) {if (!p.capturedEventParam && this._events) {for (var g = 0; g < this._events.length; g++) {if (this._events[g].hasOwnProperty(b)) {if (c = this._events[g], e = c.bounds, d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2) {c[b].call(c.context, d.x, d.y); "mousedown" === b && !0 === c.capture ? (p.capturedEventParam = c, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === b && (c.chart.overlaidCanvas.releaseCapture ?
      c.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", this._mouseEventHandler, !1));                                                                                                                   break; } else { c = null; }
}
}a.target.style.cursor = c && c.cursor ? c.cursor : this._defaultCursor; }b = this.plotArea; if (d.x < b.x1 || d.x > b.x2 || d.y < b.y1 || d.y > b.y2) {this.toolTip && this.toolTip.enabled ? this.toolTip.hide() : this.resetOverlayedCanvas(); }this.isDrag && this.zoomEnabled || !this._eventManager || this._eventManager.mouseEventHandler(a); }
...
} else if ((!e || 2 < Math.abs(c)) && (!g || 2 < Math.abs(b)) && this.zoomEnabled) {if (!this.dragStartPoint) {return; }b = e ? this.dragStartPoint.x : this.plotArea.x1; c = g ? this.dragStartPoint.y : this.plotArea.y1; e = e ? a : this.plotArea.x2; g = g ? d : this.plotArea.y2; 2 < Math.abs(b - e) && 2 < Math.abs(c - g) && this._zoomPanToSelectedRegion(b, c, e, g) && (k = !0); }k &&
...
}} else if (this.toolTip.mouseMoveHandler(a, d), "none" !== this.plotInfo.axisPlacement) {if (this.axisX && 0 < this.axisX.length) {for (e = 0; e < this.axisX.length; e++) {this.axisX[e].crosshair && this.axisX[e].crosshair.enabled && this.axisX[e].renderCrosshair(a, d); } }if (this.axisX2 && 0 < this.axisX2.length) {for (e = 0; e < this.axisX2.length; e++) {this.axisX2[e].crosshair && this.axisX2[e].crosshair.enabled &&
...
}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return{isValid: l, axesWithValidRange: w, axesRanges: s}; };                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    p.prototype.preparePlotArea = function() {var a = this.plotArea; !r && (0 < a.x1 || 0 < a.y1) && a.ctx.translate(a.x1, a.y1); if ((this.axisX[0] || this.axisX2[0]) && (this.axisY[0] || this.axisY2[0])) {var d = this.axisX[0] ? this.axisX[0].lineCoordinates : this.axisX2[0].lineCoordinates; if (this.axisY && 0 < this.axisY.length && this.axisY[0]) {var b = this.axisY[0]; a.x1 = d.x1 < d.x2 ? d.x1 : b.lineCoordinates.x1; a.y1 = d.y1 < b.lineCoordinates.y1 ? d.y1 : b.lineCoordinates.y1;
...
}                                                                        r || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top = a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1)); a.layoutManager = new Ga(a.x1, a.y1, a.x2, a.y2, 2); };                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       p.prototype.renderIndexLabels = function(a) {var d = a || this.plotArea.ctx, b = this.plotArea, c = 0, e = 0, g = 0, k = 0, l = c = k = e = g = 0, w = 0; for (a = 0; a < this._indexLabels.length; a++) {var m = this._indexLabels[a], s = m.chartType.toLowerCase(), q, n, l = na("indexLabelFontColor", m.dataPoint,
    ...
    t ? Math.min(m.point.x, g) - l - e - c : g - l - e - c, v = q < m.point.x))) : (k = Math.max(m.bounds.x1, b.x1), Math.min(m.bounds.x2, b.x2), c = 0 <= s.indexOf("range") || "error" === s ? 0 > ma ? Math.max(m.bounds.x1, b.x1) + l / 2 + e : Math.min(m.bounds.x2, b.x2) - l / 2 - e : (Math.max(m.bounds.x1, b.x1) + Math.min(m.bounds.x2, b.x2)) / 2, q = 0 > ma ? Math.max(m.point.x, c) - l / 2 : Math.min(m.point.x, c) - l / 2, q = Math.max(q, k));
}"vertical" === C && (n += w); f.x = q; f.y = n; f.render(!0); p && ("inside" !== t && (0 > s.indexOf("bar") && ("error" !== s || !m.axisSwapped) && m.point.x > b.x1 && m.point.x < b.x2 ||
      ...
      this._eventManager.ghostCtx;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           b.save(); var e = this.plotArea; b.beginPath(); b.rect(e.x1, e.y1, e.width, e.height); b.clip(); for (var g = [], k, l = 0; l < a.dataSeriesIndexes.length; l++) {var w = a.dataSeriesIndexes[l], m = this.data[w]; b.lineWidth = m.lineThickness; var s = m.dataPoints, q = "solid"; if (b.setLineDash) {var n = R(m.nullDataLineDashType, m.lineThickness), q = m.lineDashType, f = R(q, m.lineThickness); b.setLineDash(f); }var B = m.id; this._eventManager.objectMap[B] = {objectType: "dataSeries", dataSeriesIndex: w}; B = N(B); c.strokeStyle = B;
        ...
        x), r && c.lineTo(C, x), 0 == t % 500 && (b.stroke(), b.beginPath(), b.moveTo(C, x), r && (c.stroke(), c.beginPath(), c.moveTo(C, x))));                                                                                                                                                                                                                                                                                                                                                             k = {x: C, y: x}; t < s.length - 1 && (h !== (s[t].lineColor || B) || q !== (s[t].lineDashType || m.lineDashType)) && (b.stroke(), b.beginPath(), b.moveTo(C, x), h = s[t].lineColor || B, b.strokeStyle = h, b.setLineDash && (s[t].lineDashType ? (q = s[t].lineDashType, b.setLineDash(R(q, m.lineThickness))) : (q = m.lineDashType, b.setLineDash(f)))); if (0 < s[t].markerSize || 0 < m.markerSize) {var A = m.getMarkerProperties(t, C, x, b); g.push(A);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                              y = N(y); r && g.push({x: C, y: x, ctx: c, type: A.type, size: A.size, color: y, borderColor: y, borderThickness: A.borderThickness}); }                                                                                                                                                                                                                                                                                                                                                               (s[t].indexLabel || m.indexLabel || s[t].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({chartType: "line", dataPoint: s[t], dataSeries: m, point: {x: C, y: x}, direction: 0 > s[t].y === a.axisY.reversed ? 1 : -1, color: B}); }
}
}b.stroke(); r && c.stroke(); }}                                                                                                                                             ia.drawMarkers(g); r && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
    ...
    r && c.stroke()), u = !0;
} else {var y = x; C = a.axisX.convertValueToPixel(C); x = a.axisY.convertValueToPixel(s[t].y); var A = m.dataPointIds[t]; this._eventManager.objectMap[A] = {id: A, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: t, x1: C, y1: x}; p || u ? (!p && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || q === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(k.x, k.y), q = m.nullDataLineDashType, b.setLineDash(n)), b.lineTo(C, y), b.lineTo(C, x), r && (c.lineTo(C,
...
}b.stroke(); r && c.stroke(); }}ia.drawMarkers(g); r &&
...
}c.stroke(); r && e.stroke(); }}var b = a.targetCanvasCtx || this.plotArea.ctx, c = r ? this._preRenderCtx : b; if (!(0 >= a.dataSeriesIndexes.length)) {var e = this._eventManager.ghostCtx; c.save(); var g = this.plotArea; c.beginPath();
...
}d(x); }ia.drawMarkers(k); r && (b.drawImage(this._preRenderCanvas,
...
}c(); ia.drawMarkers(m); }}r && (e.drawImage(this._preRenderCanvas,
    ...
    e.save();                                                                                                                                                                                                                                                                                                                                                                                         c.beginPath(); c.rect(w.x1, w.y1, w.width, w.height); c.clip(); r && (e.beginPath(), e.rect(w.x1, w.y1, w.width, w.height), e.clip()); for (var m = 0; m < a.dataSeriesIndexes.length; m++) {var s = a.dataSeriesIndexes[m], q = this.data[s], n = q.dataPoints, l = q.id; this._eventManager.objectMap[l] = {objectType: "dataSeries", dataSeriesIndex: s}; l = N(l); e.fillStyle = l; var l = [], f = 0, B, h, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), t, u = null, x = []; if (0 < n.length) {var ma = q._colorSet[f % q._colorSet.length],
      ...
      point: {x: B, y: h}, direction: 0 > n[f].y === a.axisY.reversed ? 1 : -1, color: ma});                                     h = !1; }
}
}                                                                                                                                                                                                                                                                                                                                                                                                 d(); ia.drawMarkers(l); }}                                                                                                                                                                                                                                                                                              r && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(w.x1, w.y1, w.width, w.height),
...
}}                                                                                                                                                                                                               d(); c.moveTo(f, h); r && u.moveTo(f, h); }delete A.dataPointIndexes; }ia.drawMarkers(k); r && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
...
}}d(); c.moveTo(f, h); r && x.moveTo(f, h); }delete A.dataPointIndexes; }ia.drawMarkers(l); r && (b.drawImage(this._preRenderCanvas, 0,
...
}                                                                                                                       d(); ia.drawMarkers(g); }}                                                                                                                                                   r && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(k.x1, k.y1,
    ...
    1].y);                                                                                                                                                                                                                                                                                       for (f = d.length - 1; 2 < f; f -= 3) {c.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), r && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y); }c.closePath(); c.globalAlpha = m.fillOpacity; c.fill(); r && (e.closePath(), e.fill()); c.globalAlpha = 1; if (0 < m.lineThickness) {c.strokeStyle = b; c.setLineDash && c.setLineDash(a); c.beginPath(); c.moveTo(d[0].x, d[0].y); for (var g = f = 0; f < d.length - 3; f += 3, g++) {if (u[g].newStrokeStyle || u[g].newLineDashArray) {c.stroke(), c.beginPath(), c.moveTo(d[f].x,
      ...
      dataPoint: h[q], dataSeries: m, indexKeyword: 1, point: {x: n, y: p}, direction: h[q].y[0] <= h[q].y[1] ? 1 : -1, color: t});
                     }                                                                                                                                                                   f = !1; } else { 0 < q && !f && (m.connectNullData ? c.setLineDash && (0 < u.length && (m.options.nullDataLineDashType || !h[q - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A, F = m.nullDataLineDashType) : (d(y, C), u = [], z = [])), f = !0; }
}
                                                                                                                                                                                                                                                                }d(y, C); ia.drawMarkers(g); }}r && (b.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0,
...
}                                                                                                                                                                                   a.save(); }function c(a, b) {var c = 0, c = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height / 2, e = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height / 2, d = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height /
...
}q = m; h = e(a); l = m = 0; 0 > b ? (l = "right" === n.hemisphere ? q : h, k = b, null !== l && (q = -b, b = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (f[l].indexLabelTextBlock.y + f[l].indexLabelTextBlock.height / 2), b - q < p && (m = -q, l = g(l, m, d + 1), +l.toFixed(C) > +m.toFixed(C) && (k = b > p ? -(b - p) : -(q - (l - m)))))) : 0 < b && (l = "right" ===
    ...
    +E.toFixed(C) && +H.toFixed(C) <= +u.toFixed(C) && g(a, -(E - I))) : (H = g(y, u), E = -1 * (z - H), I = g(a, E), +I.toFixed(C) < +E.toFixed(C) && +H.toFixed(C) <= +u.toFixed(C) && g(y, -(E - I))); }}}} else { for (a = 0; a < s.length; a++) {l = f[a], r = "pie" === m.type ? 0.7 * A : 0.8 * A, y = x.x + r * Math.cos(l.midAngle), u = x.y + r * Math.sin(l.midAngle), l.indexLabelTextBlock.x = y, l.indexLabelTextBlock.y = u; } }for (a = 0; a < s.length; a++) {if (l = f[a], y = l.indexLabelTextBlock.measureText(), 0 !== y.height && 0 !== y.width) {y = y = 0, "right" === l.hemisphere ? (y = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width +
      ...
      2, w = t.indexLabelTextBlock.y + t.indexLabelTextBlock.height / 2, p = m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2, u = m.indexLabelTextBlock.x + m.indexLabelTextBlock.width, r = m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     n = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < m.indexLabelTextBlock.x - q || n > u + q || h > r + q || w < p - q ? !1 : !0; }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  n ? (0 > a && (a = l), k !== a && (b = k, d += -z), 0 === l % Math.max(s.length / 10, 3) && (g = !0)) : g = !0; g && (0 < d && 0 <= a && 0 <= b) && (K(d, a, b), b = a = -1, d = 0); }}
}                                                                                                                                                                                                                                                                                                                                                 0 < d && K(d, a, b); })(); }}function l() {h.plotArea.layoutManager.reset();
    ...
    d.x5 && (a.lineTo(Math.round(d.x5), Math.round(d.y5)), a.lineTo(Math.round(d.x6), Math.round(d.y6))), a.closePath(), a.fillStyle = c ? c : d.color, a.fill(), a.globalAplha = 1, a.restore()); };                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           p.prototype.renderFunnel = function(a) {function d() {for (var a = 0, b = [], c = 0; c < C.length; c++) {if ("undefined" === typeof C[c].y) {return-1; }C[c].y = "number" === typeof C[c].y ? C[c].y : 0; a += Math.abs(C[c].y); }if (0 === a) {return-1; }for (c = b[0] = 0; c < C.length; c++) {b.push(Math.abs(C[c].y) * F / a); }return b; }function b() {var a = $, b = V, c = K, e = ea, d, f; d = O; f = Z - N; e = Math.abs((f -
...
}}                                                                                                                                                                             for (l = P.length - 1; 0 < l; l--) {if (!J[l].isDirty) {e = q(l); if (0 > e && (e = 0, J[e].isDirty)) {break; }if (J[l].textBlock.y < J[e].textBlock.y + J[e].height) {d = d || l; f = l; for (k = 0; J[f].textBlock.y < J[e].textBlock.y + J[e].height + ga;) {a = a || J[f].textBlock.y + J[f].height; k += J[f].height; k += ga; f = e; if (0 >= f) {f = 0; k += J[f].height; break; }e = q(f);
                                                                                                                                                                                                                                                                                                                                                                                                                           if (0 > e) {f = 0; k += J[f].height; break; }}                                                                                                                                                                                                                                                                                                             if (f != l) {g = J[f].textBlock.y; a -= g; a = k - a; g = c(a, d, f); break; }}}
                                                                                                                                                                             }                                                                                                                                                                                                                                                                                           return g; }function c(a, b, d) {var e = [], f = 0, g = 0; for (a = Math.abs(a); d <= b; d++) {e.push(P[d]); }e.sort(function(a, b) {return a.height - b.height; }); for (d = 0; d < e.length; d++) {if (b = e[d], f < a) {g++, f += J[b.id].height + ga, J[b.id].textBlock.text = "", J[b.id].indexLabelText = "", J[b.id].isDirty = !0, J[b.id].textBlock.measureText(); } else { break; } }return g; }for (var d, e, f, g, k, m, h = 1, s = 0; s < 2 * h; s++) {for (var w = J.length - 1; 0 <= w && !(0 <= q(w) && q(w), f = J[w], g = f.textBlock,
      ...
      ia;
} else {e = D * (1 != W.length || 0 != W[0] && W[0] != P.length - 1 ? 2 : 1) / m(); for (var q = 0; q < P.length; q++) {if (1 == W.length && 0 == W[0]) {if (0 === q) {k.push(ia[q]); d = l; continue; }} else { 0 === q && (d = -1 * l); }k.push(ia[q] + d); if (0 <= W.indexOf(q) || q < P.length && 0 <= W.indexOf(q + 1)) {d += e; }}}                                                                                                               f = function() {for (var a = [], b = 0; b < P.length; b++) {a.push(k[b] - P[b].y1); }return a; }(); var w = {startTime: (new Date).getTime(), duration: c || 500, easingFunction: function(a, b, c, d) {return M.easing.easeOutQuart(a, b, c, d); }, changeSection: function(a) {for (var b, c, d = 0; d < P.length; d++) {b =
...
}}                                                                 function q(a) {for (a -= 1; -1 <= a && -1 != a && J[a].isDirty; a--) { }return a; }function n(a) {for (a += 1; a <= P.length && a != P.length && J[a].isDirty; a++) { }return a; }function f(a) {for (var b, c = 0; c < C.length; c++) {if (P[c].y1 < a && P[c].y4 > a) {b = P[c]; break; } }return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2),
...
}       H = H || "undefined" !== typeof t.indexLabel && null !== t.indexLabel && 0 < t.indexLabel.toString().length; "inside" !== t.indexLabelPlacement && H || (y = (x.width - 0.75 * E) / 2); var I = x.x1 + y, L = x.x2 - y, O = x.y1 + D, Z = x.y2 - D, Q = a.targetCanvasCtx || this.plotArea.ctx || this.ctx; if (0 != t.length && (t.dataPoints &&
...
}                         if (d.hasOwnProperty(a)) {f = d; } else if (b.hasOwnProperty(a)) {f = b; } else { return""; }f = f[a]; null !== k && (f = f[k]); if ("x" === a) {if ("dateTime" === b.axisX.valueType || "dateTime" === b.xValueType || d.x && d.x.getTime) {if (g.plotInfo.plotTypes[0].plotUnits[0].axisX && !g.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic) {return Ca(f, d.xValueFormatString ?
    ...
    "bottom" === this.verticalAlign ? (this.orientation = "horizontal", b = this.verticalAlign, g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical", b = this.horizontalAlign, g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width, k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height); this.errorMarkerColor = []; for (var s = 0; s < this.dataSeries.length; s++) {var q = this.dataSeries[s];
        ...
        !1 !== x.showInLegend) && h.push(n); }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          }}                                                                                                                                                          !0 === this.reversed && h.reverse(); if (0 < h.length) {q = null; p = f = x = z = 0; x = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, g) : this.itemMaxWidth = Math.min(this.itemWidth, g) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, g) : this.itemMaxWidth = g; r = 0 === r ? 0.75 * this.lineHeight : r; x -= r + l; for (s = 0; s < h.length; s++) {n = h[s]; v = x; if ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType) {v -= 2 * 0.1 * this.lineHeight; }if (!(0 >= k || "undefined" ===
    ...
    n.chartType ? 2 * 0.1 * this.lineHeight : 0)));                                        if (!q || q.width + Math.round(n.textBlock.width + r + l + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) {q = {items: [], width: 0}, m.push(q), this.height += f, f = 0; }f = Math.max(f, n.textBlock.height); } else { n.textBlock = new ka(this.ctx, {x: 0, y: 0, maxWidth: x, maxHeight: !0 === this.itemWrap ? k : 1.5 * this.fontSize, angle: 0, text: n.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily,
...
}n.textBlock.x = q.width; n.textBlock.y = 0; q.width += Math.round(n.textBlock.width + r + l + (0 === q.width ?
...
}                              this.markerSize = r; this.rows = m; 0 < h.length && a.layoutManager.registerSpace(b, {width: this.width + 2 + 2, height: this.height + 5 + 5}); this.bounds = {x1: e, y1: c, x2: e + this.width, y2: c + this.height}; };                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    H.prototype.render = function() {var a = this.bounds.x1, d = this.bounds.y1, b = this.markerMargin, c = this.maxWidth, e = this.maxHeight, g = this.markerSize, k = this.rows; (0 < this.borderThickness &&
      ...
      2 || Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness && d >= n.y1 && d <= n.y4) {c.push({dataPoint: f, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(n.x1 - a), Math.abs(n.x2 - a), Math.abs(n.y2 - d), Math.abs(n.y3 - d))}), l = !0; }                                                                                                                                                                                               break; case "candlestick": if (a >= n.x1 - n.borderThickness / 2 && a <= n.x2 + n.borderThickness / 2 && d >= n.y2 - n.borderThickness / 2 && d <= n.y3 + n.borderThickness / 2 || Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness && d >= n.y1 && d <= n.y4) {c.push({dataPoint: f, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(n.x1 - a),
        Math.abs(n.x2 - a), Math.abs(n.y2 - d), Math.abs(n.y3 - d))}), l = !0;
...
} else {if (u(this.options.labelWrap)) {if (!u(this.options.labelMaxWidth)) {this.options.labelMaxWidth < g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
...
} else if (!u(d)) {if (c = B.width + d.width >> 0, f = this.labelFontSize, n < g) {c - 2 * g > q && (q = c - 2 * g, c >= 2 * g && c < 2.2 * g ? (this.sessionVariables.labelMaxWidth = g, u(this.options.labelFontSize) && 12 < f && (f = Math.floor(12 / 13 * f), a.measureText()), this.sessionVariables.labelFontSize = u(this.options.labelFontSize) ? f : this.options.labelFontSize, this.sessionVariables.labelAngle =
...
} else if ("left" === this._position || "right" === this._position) {if (g = u(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, k = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {this.sessionVariables.labelFontSize = this.labelFontSize; this.sessionVariables.labelMaxWidth =
...
}for (b = 0; b < this.stripLines.length; b++) {var g = this.stripLines[b], z; if ("outside" === g.labelPlacement) {k = this.sessionVariables.labelMaxWidth;
...
}}                                                                             d = this.title ? this._titleTextBlock.measureText().height + 2 : 0; return c = "inside" === this.labelPlacement ? c = d + b : d + a + this.tickLength + b; };                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            z.prototype.createLabelsAndCalculateHeight = function() {var a = 0; this._labels = []; this._stripLineLabels = []; var d,
...
}for (var z = v = 0, t = 0, C = 0, x = 0, D = 0, y = 0, A, E, F = l = 0, H, I, L, r = H = I = L = !1, f = 0; f < n.length; f++) {n[f] && n[f].title && (n[f]._titleTextBlock = new ka(n[f].ctx, {text: n[f].title, horizontalAlign: "center", fontSize: n[f].titleFontSize, fontFamily: n[f].titleFontFamily,
...
}for (f = 0; f < n.length; f++) {if (n[f].title) {switch (n[f]._position) {case "left": n[f]._titleTextBlock.maxWidth = n[f].titleMaxWidth || g.height; n[f]._titleTextBlock.maxHeight = n[f].titleWrap ? 0.8 * g.width : 1.5 * n[f].titleFontSize; n[f]._titleTextBlock.angle =
...
}if ("normal" === e) {for (var C = [], x = [], D = [], y = [], M = [], N = [], O = [], Q = []; 4 > v;) {var G = 0, R = 0, S = 0, U = 0, W = e = 0, K = 0, $ = 0, V = 0, X = 0, P = 0, ba = 0; if (b &&
...
} else { x.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0)); }N.push(x); if (a && 0 < a.length) {for (f = 0; f < a.length; f++) {a[f] && (a[f].lineCoordinates.x1 =
    ...
    c[f].labelAutoFit && !u(D) && (0 < !a.length && (k = 0 < c[f].labelAngle ? Math.max(k, D) : 0 === c[f].labelAngle ? Math.max(k, D / 2) : k), 0 < !d.length && (h -= y / 2)), c[f].lineCoordinates.x1 = k, c[f].lineCoordinates.x2 = h, c[f].lineCoordinates.width = Math.abs(h - k), c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.width ? c[f].titleMaxWidth : c[f].lineCoordinates.width);
      ...
      180 * Math.abs(m.textBlock.angle)), y = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle)));
                                                         ...
                                                         }                                                                                                                      if (p.panEnabled) {for (f = 0; f < b.length; f++) {q[f] = p.sessionVariables.axisY.height; } } else { for (f = 0; f < b.length; f++) {p.sessionVariables.axisY.height = q[f]; } }if (b && 0 < b.length) {for (f = b.length - 1; 0 <= f; f--) {l = Math.round(g.y2), m = Math.round(g.y2 > b[f].chart.height - 10 ? b[f].chart.height - 10 : g.y2), b[f].lineCoordinates.y1 = l - (q[f] + b[f].margin +
      X), b[f].lineCoordinates.y2 = l - (q[f] + b[f].margin + X), b[f].bounds = {x1: k, y1: l - (q[f] + X + b[f].margin), x2: h, y2: m - (X + b[f].margin), width: h - k, height: q[f]}, b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.width ? b[f].titleMaxWidth : b[f].lineCoordinates.width), X += q[f] + b[f].margin;
...
}if (c && 0 < c.length) {for (f = c.length - 1; 0 <= f; f--) {c[f] && (l = Math.round(g.y1), m = Math.round(g.y1 + (A[f] + c[f].margin + G)), c[f].lineCoordinates.y1 = m, c[f].lineCoordinates.y2 = m, c[f].bounds = {x1: k, y1: l +
        (c[f].margin + G), x2: h, y2: m, width: h - k, height: R}, c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.width ? c[f].titleMaxWidth : c[f].lineCoordinates.width), G += A[f] + c[f].margin);
...
}                                                                                         if (a && 0 < a.length) {for (f = 0; f < a.length; f++) {K = a[f]._labels && 0 < a[f]._labels.length ? a[f]._labels[0].textBlock.fontSize / 2 : 0; k = Math.round(g.x1 + e); l = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y2 : g.y1 < Math.max(K, 10) ? Math.max(K, 10) : g.y1) : g.y1 < Math.max(K, 10) ? Math.max(K, 10) : g.y1;
                                                                                         ...
                                                                                         }if (d && 0 < d.length) {for (f = 0; f < d.length; f++) {K = d[f]._labels && 0 < d[f]._labels.length ? d[f]._labels[0].textBlock.fontSize / 2 : 0; k = Math.round(g.x1 -
...
}};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  z.prototype.calculateBreaksSizeInValues = function() {for (var a = "left" ===
...
}};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     z.prototype.calculateBreaksInPixels = function() {if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {var a = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : []; a.length && (this.scaleBreaks.firstBreakIndex = this.scaleBreaks.lastBreakIndex = null); for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++) {a[d].endValue <
...
}}};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           z.prototype.renderLabelsTicksAndTitle = function() {var a = this, d = !1, b = 0, c = 0, e = 1, g = 0; 0 !== this.labelAngle && 360 !== this.labelAngle && (e = 1.2); if ("undefined" ===
...
}}this.logarithmic && (!this.equidistantInterval && this.labelAutoFit) && this._labels.sort(function(a, b) {return a.position - b.position; }); var m = 0, q, n; if ("bottom" === this._position) {for (m = 0; m < this._labels.length; m++) {q = this._labels[m],
...
}                                                                                                                                                                                              "inside" === this.labelPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {for (m = 0; m < a._labels.length; m++) {if (q = a._labels[m], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum || d && 0 !== g++ % 2 && a.labelAutoFit) &&
...
}}, this); this.title && (this._titleTextBlock.measureText(), this._titleTextBlock.x = this.bounds.x1 + 1, this._titleTextBlock.y = this.lineCoordinates.height / 2 + this._titleTextBlock.width / 2 + this.lineCoordinates.y1, this.titleMaxWidth = this._titleTextBlock.maxWidth, this._titleTextBlock.render(!0)); } else if ("right" ===
...
} else { for (m = 0; m < this._labels.length; m++) {q = this._labels[m], q.position < this.viewportMinimum || (q.position > this.viewportMaximum || d && 0 !== g++ % 2 && this.labelAutoFit) || q.textBlock.render(!0); } }};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            z.prototype.renderInterlacedColors = function() {var a = this.chart.plotArea.ctx, d, b, c = this.chart.plotArea,
 ...
 }a.beginPath(); };                                                                                                                                                       z.prototype.renderStripLinesOfThicknessType = function(a) {if (this.stripLines && 0 < this.stripLines.length && a) {for (var d = this, b, c = 0, e = 0, g = !1, k = !1, l = [], h = [],
    ...
    b.stripLine.labelAlign ? (this.chart.plotArea.y2 + this.chart.plotArea.y1 - b.textBlock.width) / 2 : this.chart.plotArea.y1 + 3) : "top" === this._position ? (b.textBlock.maxWidth = this.options.stripLines[c].labelMaxWidth ? this.options.stripLines[c].labelMaxWidth : this.chart.plotArea.height - 3, b.textBlock.measureText(), a.x - b.textBlock.height > this.chart.plotArea.x1 ? u(m.startValue) ? a.x -= b.textBlock.height - b.textBlock.fontSize / 2 : a.x -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3 : (b.textBlock.angle = 90, u(m.startValue) ? a.x +=
      ...
      3);
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             b.textBlock.x = a.x; b.textBlock.y = a.y; h.push(b); }
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       if (!k) {k = !1; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); for (c = 0; c < l.length; c++) {m = l[c], m.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip();
                                                                                                                                                                                                                                                                                                                                                                for (e = 0; e < l.length; e++) {m = l[e], m.showOnTop && m.render(); }this.ctx.restore(); }, m)) : m.render();
...
}this.ctx.restore(); k = !0; }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  if (k) {for (k = !1, c = 0; c < h.length; c++) {b = h[c], b.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {for (e = 0; e < h.length; e++) {b = h[e], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0); }}, b.textBlock)) : "outside" === b.stripLine.labelPlacement && b.textBlock.render(!0); } }}};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  z.prototype.renderBreaksBackground = function() {this.chart._breaksCanvas && (this.scaleBreaks &&
...
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         this.maskCtx.restore(); }};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               z.prototype.renderCrosshair = function(a, d) {this.crosshair.render(a, d); }; z.prototype.renderGrid = function() {if (this.gridThickness && 0 < this.gridThickness) {var a = this.chart.ctx; a.save(); var d, b = this.chart.plotArea; a.lineWidth = this.gridThickness; a.strokeStyle = this.gridColor; a.setLineDash && a.setLineDash(R(this.gridDashType, this.gridThickness)); if ("bottom" === this._position || "top" === this._position) {for (c = 0; c < this._labels.length; c++) {this._labels[c].position <
    this.viewportMinimum || (this._labels[c].position > this.viewportMaximum || this._labels[c].breaksLabelType) || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[c].position), d = 1 === a.lineWidth % 2 ? (d.x << 0) + 0.5 : d.x << 0, a.moveTo(d, b.y1 << 0), a.lineTo(d, b.y2 << 0), a.stroke());
...
} else if ("left" === this._position || "right" === this._position) {for (var c = 0; c < this._labels.length; c++) {this._labels[c].position < this.viewportMinimum || (this._labels[c].position > this.viewportMaximum || this._labels[c].breaksLabelType) || (a.beginPath(),
...
}                                                                                                                                                                                                                                                                 e && (d.moveTo(e, k), d.lineTo(g, k)); d.stroke(); }} else if (("left" === this._position || "right" === this._position) && this.lineThickness) {this.reversed ? (e = this.lineCoordinates.y1, g = this.lineCoordinates.y2) : (e = this.lineCoordinates.y2, g = this.lineCoordinates.y1); d.lineWidth = this.lineThickness; d.strokeStyle = this.lineColor;
      ...
      d.y = this.lineCoordinates.y1;
...
}        d = !1; } else if (c > e[b].startValue / this.conversionParameters.minimum) {c /= e[b].startValue / this.conversionParameters.minimum; if (c < e[b].size) {a *= Math.pow(e[b].endValue / e[b].startValue, 1 === e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) / c; break; } else { a *= e[b].endValue / e[b].startValue /
        e[b].size;
}                                                                                                                                                                                                                                                                                                       c /= e[b].size; d = !1; } else { break; }
} else if (c > e[b].startValue / e[b - 1].endValue) {c /= e[b].startValue / e[b - 1].endValue; if (c < e[b].size) {a *= Math.pow(e[b].endValue / e[b].startValue, 1 === e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) / c; break; } else { a *= e[b].endValue / e[b].startValue / e[b].size; }c /= e[b].size; } else { break; }
}}
                                                                                                                                                                                                                                                                                                                                                                                                                               } else { for (b = e.length - 1; 0 <= b; b--) {if (!(e[b].startValue > this.conversionParameters.minimum)) {if (d) {if (e[b].endValue > this.conversionParameters.minimum) {if (1 < e[b].size && this.conversionParameters.minimum * Math.pow(e[b].endValue /
        ...
        e[b].endValue / this.conversionParameters.minimum;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 if (c > 1 / e[b].size) {a *= Math.pow(e[b].endValue / e[b].startValue, 1 >= e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) * c; break; } else { a /= e[b].endValue / e[b].startValue / e[b].size; }c *= e[b].size; d = !1; } else { break; }
} else if (c < e[b].endValue / e[b + 1].startValue) {c /= e[b].endValue / e[b + 1].startValue; if (c > 1 / e[b].size) {a *= Math.pow(e[b].endValue / e[b].startValue, 1 >= e[b].size ? 1 : Math.log(c) / Math.log(e[b].size)) * c; break; } else { a /= e[b].endValue / e[b].startValue / e[b].size; }c *= e[b].size; } else { break; }
}
 }
                                                                                                                                                                                                                                                                                                                                                                                                                               }
...
} else if (c > e[b].startValue - e[b - 1].endValue) {c -= e[b].startValue - e[b - 1].endValue; if (c < e[b].size) {a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) - c; break; } else { a += e[b].endValue - e[b].startValue - e[b].size; }c -= e[b].size; } else { break; }
}}
...
} else if (c < e[b].endValue - this.conversionParameters.minimum) {c -= e[b].endValue - this.conversionParameters.minimum; if (c > -1 * e[b].size) {a += (e[b].endValue -
      e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) + c;                                                                                                                                                                                                                                                                                                                                                                                                                                                             break; } else { a -= e[b].endValue - e[b].startValue - e[b].size; }                                                                                                                                                                                                                                                                                                                                 c += e[b].size; d = !1; } else { break; }
} else if (c < e[b].endValue - e[b + 1].startValue) {c -= e[b].endValue - e[b + 1].startValue; if (c > -1 * e[b].size) {a += (e[b].endValue - e[b].startValue) * (0 === e[b].size ? 1 : c / e[b].size) + c; break; } else { a -= e[b].endValue - e[b].startValue - e[b].size; }c += e[b].size; } else { break; }
}
 }
}d = this.conversionParameters.minimum + a; }return d; };                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                z.prototype.convertValueToPixel = function(a) {a = this.getApparentDifference(this.conversionParameters.minimum,
...
}d.minimum = this.viewportMinimum; d.maximum = this.viewportMaximum; d.range = c; if ("bottom" === this._position || "top" === this._position) {this.logarithmic ? (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? -1 : 1) * b * d.lnLogarithmBase / Math.log(Math.abs(c))) : d.pixelPerUnit = (this.reversed ? -1 : 1) * b / Math.abs(c), d.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1; }if ("left" ===
    ...
    (this.viewportMinimum = this.viewportMaximum = null);                                                                                                                                                                                                                                                                                                                                                                                                                     if (u(this.options.viewportMinimum) && !u(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) {this.viewportMinimum = this.sessionVariables.newViewportMinimum; } else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) {this.viewportMinimum = this.minimum; }if (u(this.options.viewportMaximum) && !u(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum)) {this.viewportMaximum = this.sessionVariables.newViewportMaximum; } else if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) {this.viewportMaximum = this.maximum; }                                                                                                                                                                                                                                                                                                                                                                   if (this.scaleBreaks) {for (c = 0; c < this.scaleBreaks._appliedBreaks.length; c++) {if ((!u(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue || !u(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[c].startValue || !u(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue) &&
      (!u(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue || !u(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[c].endValue || !u(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue)) {this.scaleBreaks._appliedBreaks.splice(c, 1); break; }
                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                   }                                                                         if ("axisX" === this.type) {if (this.dataSeries && 0 < this.dataSeries.length) {for (e = 0; e < this.dataSeries.length; e++) {"dateTime" === this.dataSeries[e].xValueType &&
    (b = !0);
}
      ...
      this.options.maximum && (this.minimum -= 10));
                   ...
                   }                                                                                                                                                                                                                                                                                                                                                                                                                          u(this.sessionVariables.newViewportMinimum) && (this.viewportMinimum = Math.max(this.viewportMinimum, this.minimum)); u(this.sessionVariables.newViewportMaximum) && (this.viewportMaximum = Math.min(this.viewportMaximum, this.maximum)); this.range = this.viewportMaximum - this.viewportMinimum; this.intervalStartPosition = "axisX" === this.type && b ? this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval) : Math.floor((this.viewportMinimum + 0.2 * this.interval) /
...
}                                                                                                                                                                                                                                                                                                                                                                                                                                 this.ctx.bezierCurveTo(h + g * a, m + a, h + g * a, m + 2 * a, h, m + 3 * a); h = k; g *= -1; this.ctx.lineTo(h, m); for (n = 0; n < p; n++) {this.ctx.bezierCurveTo(h + g * a, m - a, h + g * a, m - 2 * a, h, m - 3 * a), m -= 3 * a, g *= -1; }} else {if ("zigzag" === this.type) {g = -1; m = e + a; h = c + a; p = (l - m) / a / 2; for (n = 0; n < p; n++) {this.ctx.lineTo(h, m), h += 2 * g * a, m += 2 * a, g *= -1; }this.ctx.lineTo(h, m); h += k - c; for (n = 0; n < p + 1; n++) {this.ctx.lineTo(h, m), h += 2 * g * a, m -= 2 * a, g *= -1; }this.ctx.lineTo(h + g * a, m + a); }}
    ...
    this.parent.dataSeries.length; r++) {(f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && (f.dataSeries = this.parent.dataSeries[r], null !== f.dataPoint.y && k.push(f)); }                                                                    f = null; if (0 === k.length) {return; }k.sort(function(a, b) {return a.distance - b.distance; }); f = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y)); r = 0; if ("rangeBar" === k[0].dataSeries.type || "error" === k[0].dataSeries.type) {for (var f = Math.abs(a - this.parent.convertValueToPixel(k[r].dataPoint.y[0])), v = 0, n = 0; n < k.length; n++) {if (k[n].dataPoint.y &&
      k[n].dataPoint.y.length) {for (h = 0; h < k[n].dataPoint.y.length; h++) {v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y[h])), v < f && (f = v, r = n); } } else { v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y)), v < f && (f = v, r = n); }
}
} else if ("stackedBar" === k[0].dataSeries.type) {for (var f = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y)), D = v = 0, n = r = 0; n < k.length; n++) {if (k[n].dataPoint.y && k[n].dataPoint.y.length) {for (h = 0; h < k[n].dataPoint.y.length; h++) {v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y[h])),
    v < f && (f = v, r = n);
}
} else { D += k[n].dataPoint.y, v = Math.abs(a - this.parent.convertValueToPixel(D)), v < f && (f = v, r = n); }
}
 } else if ("stackedBar100" === k[0].dataSeries.type) {for (var f = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y)), t = D = v = 0, n = 0; n < k.length; n++) {if (k[n].dataPoint.y && k[n].dataPoint.y.length) {for (h = 0; h < k[n].dataPoint.y.length; h++) {v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y[h])), v < f && (f = v, r = n); } } else { D += k[n].dataPoint.y, t = k[n].dataPoint.x.getTime ? k[n].dataPoint.x.getTime() : k[n].dataPoint.x,
      t = 100 * (D / k[n].dataSeries.plotUnit.dataPointYSums[t]), v = Math.abs(a - this.parent.convertValueToPixel(t)), v < f && (f = v, r = n);
}
}
 } else { for (f = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y)), n = r = v = 0; n < k.length; n++) {if (k[n].dataPoint.y && k[n].dataPoint.y.length) {for (h = 0; h < k[n].dataPoint.y.length; h++) {v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y[h])), v < f && (f = v, r = n); } } else { v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y)), v < f && (f = v, r = n); } } }h = k[r]; if ("bottom" === this.parent._position ||
 ...
 }b = c = k; e = this.chart.plotArea.y1; g = this.chart.plotArea.y2; this.bounds = {x1: b - m / 2, y1: e, x2: c + m / 2, y2: g}; l.x = b - l.measureText().width / 2; l.x + l.width > this.chart.bounds.x2 ? l.x = this.chart.bounds.x2 - l.width : l.x < this.chart.bounds.x1 && (l.x = this.chart.bounds.x1); l.y = this.parent.lineCoordinates.y2 +
...
}l.y = g + l.fontSize / 2 - l.measureText().height / 2 + 2; l.y - l.fontSize / 2 < this.chart.bounds.y1 ? l.y = this.chart.bounds.y1 + l.fontSize / 2 + 2 : l.y + l.measureText().height -
...
}l.x = b - l.measureText().width / 2; l.x + l.width > this.chart.bounds.x2 && (l.x = this.chart.bounds.x2 - l.width); l.x < this.chart.bounds.x1 &&
...
}                                                                                                                                                                                                          if (0 === k.length) {return; }k.sort(function(a, b) {return a.distance - b.distance; }); r = 0; if ("rangeColumn" === k[0].dataSeries.type || "rangeArea" === k[0].dataSeries.type || "error" === k[0].dataSeries.type || "rangeSplineArea" === k[0].dataSeries.type || "candlestick" === k[0].dataSeries.type || "ohlc" === k[0].dataSeries.type || "boxAndWhisker" === k[0].dataSeries.type) {for (f = Math.abs(d - this.parent.convertValueToPixel(k[0].dataPoint.y[0])), n = v = 0; n < k.length; n++) {if (k[n].dataPoint.y &&
      k[n].dataPoint.y.length) {for (h = 0; h < k[n].dataPoint.y.length; h++) {v = Math.abs(d - this.parent.convertValueToPixel(k[n].dataPoint.y[h])), v < f && (f = v, r = n); } } else { v = Math.abs(d - this.parent.convertValueToPixel(k[n].dataPoint.y)), v < f && (f = v, r = n); }
}
} else if ("stackedColumn" === k[0].dataSeries.type || "stackedArea" === k[0].dataSeries.type) {for (f = Math.abs(d - this.parent.convertValueToPixel(k[0].dataPoint.y)), n = D = v = 0; n < k.length; n++) {if (k[n].dataPoint.y && k[n].dataPoint.y.length) {for (h = 0; h < k[n].dataPoint.y.length; h++) {v = Math.abs(d - this.parent.convertValueToPixel(k[n].dataPoint.y[h])),
    v < f && (f = v, r = n);
}
} else { D += k[n].dataPoint.y, v = Math.abs(d - this.parent.convertValueToPixel(D)), v < f && (f = v, r = n); }
}
 } else if ("stackedColumn100" === k[0].dataSeries.type || "stackedArea100" === k[0].dataSeries.type) {for (f = Math.abs(d - this.parent.convertValueToPixel(k[0].dataPoint.y)), n = t = D = v = 0; n < k.length; n++) {if (k[n].dataPoint.y && k[n].dataPoint.y.length) {for (h = 0; h < k[n].dataPoint.y.length; h++) {v = Math.abs(d - this.parent.convertValueToPixel(k[n].dataPoint.y[h])), v < f && (f = v, r = n); } } else { D += k[n].dataPoint.y, t = k[n].dataPoint.x.getTime ?
    ...
    2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, c = this.chart.plotArea.x2, this.bounds = {x1: b, y1: e - m / 2, x2: c, y2: g + m / 2};
 }                                                                                                       if ("xySwapped" === this.chart.plotInfo.axisPlacement) {if ("left" === this.parent._position || "right" === this.parent._position) {t = !1; if (this.parent.labels) {for (k = Math.ceil(this.parent.interval), n = 0; n < this.parent.viewportMaximum; n += k) {if (this.parent.labels[n]) {t = !0; } else {t = !1; break; } } }if (t) {if ("axisX" === this.parent.type) {for (n = this.parent.convertPixelToValue({y: d}), f = null, r = 0; r < this.parent.dataSeries.length; r++) {(f =
...
}l.y = d + l.fontSize / 2 - l.measureText().height / 2 + 2; l.y - l.fontSize / 2 < this.chart.bounds.y1 ? l.y = this.chart.bounds.y1 + l.fontSize / 2 + 2 : l.y + l.measureText().height -
      ...
      ba(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label, l.x = b - l.measureText().width / 2, l.x + l.width > this.chart.bounds.x2 && (l.x = this.chart.bounds.x2 - l.width), l.x < this.chart.bounds.x1 && (l.x = this.chart.bounds.x1), "bottom" === this.parent._position && (l.y = this.parent.lineCoordinates.y2 + l.fontSize / 2 + 2), "top" === this.parent._position && (l.y = this.parent.lineCoordinates.y1 - l.height + l.fontSize / 2 + 2);
                                                                                                       ...
                                                                                                       } else if ("bottom" === this.parent._position || "top" === this.parent._position) {t =
...
}} else {"dateTime" === this.parent.valueType ? l.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(a)}) : u(this.options.label) ? Ca(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (l.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options,
...
}                                                                                                                                                                                                                                                                                                              l.x = b - l.measureText().width / 2; l.x + l.width > this.chart.bounds.x2 && (l.x = this.chart.bounds.x2 - l.width); l.x < this.chart.bounds.x1 && (l.x = this.chart.bounds.x1); "bottom" === this.parent._position ? l.y = this.parent.lineCoordinates.y2 + l.fontSize / 2 + 2 : "top" === this.parent._position && (l.y = this.parent.lineCoordinates.y1 - l.height +
 ...
 }0 < m && (p.moveTo(b, e), p.lineTo(c, g), p.stroke()); p.restore(); !u(l.text) && ("number" === typeof l.text.valueOf() || 0 < l.text.length) && l.render(!0); }p.globalAlpha = q; };                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           qa($, V); $.prototype._initialize = function() {if (this.enabled) {this.container = document.createElement("div");
...
}} else {l = []; if (this.chart.axisX) {for (h = 0; h < this.chart.axisX.length; h++) {for (k = this.chart.axisX[h].convertPixelToValue({x: a}), m = null, c = 0; c < this.chart.axisX[h].dataSeries.length; c++) {(m = this.chart.axisX[h].dataSeries[c].getDataPointAtX(k, b)) && 0 <= m.index && (m.dataSeries = this.chart.axisX[h].dataSeries[c],
    null !== m.dataPoint.y && l.push(m));
}
}
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               if (this.chart.axisX2) {for (h = 0; h < this.chart.axisX2.length; h++) {for (k = this.chart.axisX2[h].convertPixelToValue({x: a}), m = null, c = 0; c < this.chart.axisX2[h].dataSeries.length; c++) {(m = this.chart.axisX2[h].dataSeries[c].getDataPointAtX(k, b)) && 0 <= m.index && (m.dataSeries = this.chart.axisX2[h].dataSeries[c], null !== m.dataPoint.y && l.push(m)); } } }}                                                                                                                                    if (0 === l.length) {return; }l.sort(function(a, b) {return a.distance - b.distance; }); b = l[0]; for (c = 0; c < l.length; c++) {l[c].dataPoint.x.valueOf() === b.dataPoint.x.valueOf() &&
    g.push(l[c]);
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             l = null; } else {if (m = this.chart.getDataPointAtXY(a, d, b)) {this.currentDataPointIndex = m.dataPointIndex, this.currentSeriesIndex = m.dataSeries.index; } else if (r) {if (m = ab(a, d, this.chart._eventManager.ghostCtx), 0 < m && "undefined" !== typeof this.chart._eventManager.objectMap[m]) {m = this.chart._eventManager.objectMap[m]; if ("legendItem" === m.objectType) {return; }this.currentSeriesIndex = m.dataSeriesIndex; this.currentDataPointIndex = 0 <= m.dataPointIndex ? m.dataPointIndex : -1; } else { this.currentDataPointIndex = -1; } } else { this.currentDataPointIndex =
      -1;
...
}                                                                                                                                                                                                                                                                                                                                                                                                    b < m.dataPoint.y.length && b > -m.dataPoint.y.length && g.push(m); } else {"column" === e.type || "bar" === e.type ? 0 > m.dataPoint.y ? 0 > m.dataSeries.axisY.viewportMinimum && m.dataSeries.axisY.viewportMaximum >= m.dataPoint.y && g.push(m) : m.dataSeries.axisY.viewportMinimum <= m.dataPoint.y && 0 <= m.dataSeries.axisY.viewportMaximum && g.push(m) : "bubble" === e.type ? (b = this.chart._eventManager.objectMap[e.dataPointIds[m.index]].size / 2, m.dataPoint.y >=
...
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  null !== d && (d = m + d); } else {b = a[0].dataSeries; c = a[0].dataPoint; e = a[0].index; if (null === c.toolTipContent || "undefined" === typeof c.toolTipContent && null === b.options.toolTipContent) {return null; }"line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" ===
...
}                                                              this.animations = a; 0 < this.animations.length ? this.animationRequestId = this.chart.requestAnimFrame.call(window, function() {g.animate.call(g); }) : this.chart.isAnimating = !1; };                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ga.prototype.cancelAllAnimations = function() {this.animations = []; this.animationRequestId && this.chart.cancelRequestAnimFrame.call(window,
...
}                                                                                                                                                                                                                               f = e.colors_; f.sort(function(a, b) {return a.offset - b.offset; }); d = f.length; p = f[0].color; c = f[d - 1].color; k = f[0].alpha * a.globalAlpha; a = f[d - 1].alpha * a.globalAlpha; for (var n = [], r = 0; r < d; r++) {var t = f[r]; n.push(t.offset * m + u + " " + t.color); }b.push('<g_vml_:fill type="', e.type_, '"', ' method="none" focus="100%"', ' color="', p, '"', ' color2="', c, '"', ' colors="', n.join(","), '"', ' opacity="', a, '"', ' g_o_:opacity2="', k, '"', ' angle="', h, '"', ' focusposition="', g, ",", l, '" />'); } else { e instanceof
I ? k && n && b.push("<g_vml_:fill", ' position="', -c.x / k * f * f, ",", -c.y / n * d * d, '"', ' type="tile"', ' src="', e.src_, '" />') : (e = G(a.fillStyle), b.push('<g_vml_:fill color="', e.color, '" opacity="', e.alpha * a.globalAlpha, '" />'));
}}function s(a, b, c) {a = a.m_; return{x: q * (b * a[0][0] + c * a[1][0] + a[2][0]) - r, y: q * (b * a[0][1] + c * a[1][1] + a[2][1]) - r}; }function z(a, b, c) {isFinite(b[0][0]) && (isFinite(b[0][1]) && isFinite(b[1][0]) && isFinite(b[1][1]) && isFinite(b[2][0]) && isFinite(b[2][1])) && (a.m_ = b, c && (a.lineScale_ = aa(ba(b[0][0] * b[1][1] - b[0][1] *
  b[1][0])))); }                                          function w(a) {this.type_ = a; this.r1_ = this.y1_ = this.x1_ = this.r0_ = this.y0_ = this.x0_ = 0; this.colors_ = []; }function I(a, b) {if (!a || 1 != a.nodeType || "IMG" != a.tagName) {throw new A("TYPE_MISMATCH_ERR"); }if ("complete" != a.readyState) {throw new A("INVALID_STATE_ERR"); }switch (b) {case "repeat": case null: case "": this.repetition_ = "repeat"; break; case "repeat-x": case "repeat-y": case "no-repeat": this.repetition_ = b; break; default: throw new A("SYNTAX_ERR"); }this.src_ = a.src; this.width_ = a.width; this.height_ = a.height; }
    ...
    k(m.y / q), "px;left:", k(m.x / q), "px;");
                                                                                                                                                                                                                                                                                                          }                                                                                                                                                                                                                                                                                                                  p.push(' ">', '<g_vml_:image src="', a.src, '"', ' style="width:', q * e, "px;", " height:", q * d, 'px"', ' cropleft="', r / l, '"', ' croptop="', y / u, '"', ' cropright="', (l - r - n) / l, '"', ' cropbottom="', (u - y - h) / u, '"', " />", "</g_vml_:group>"); this.element_.insertAdjacentHTML("BeforeEnd", p.join("")); }; d.stroke = function(a) {var b = []; b.push("<g_vml_:shape", ' filled="', !!a, '"', ' style="position:absolute;width:', 10, "px;height:", 10, 'px;"', ' coordorigin="0,0"', ' coordsize="', 10 * q, ",", 10 * q, '"',
